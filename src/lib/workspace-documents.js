...
function buildStoredWorkspaceMeta({
  ...
  return {
    ...
    blocks: normalizeWorkspaceBlocks(blocks).map((block) => ({
      ...
      advancementMark: block.advancementMark,
      primaryTag: block.primaryTag,
      secondaryTag: block.secondaryTag,
      domain: block.domain,
      confirmationStatus: block.confirmationStatus,
      suggestedPrimaryTag: block.suggestedPrimaryTag,
      suggestedDomain: block.suggestedDomain,
      extractionPassId: block.extractionPassId,
      sevenStage: block.sevenStage,
      sourceType: block.sourceType,
      supersededBy: block.supersededBy,
      resolvedAt: block.resolvedAt,
      discardedAt: block.discardedAt,
    })),
