# First Seed Assembly Walkthrough v2

**Date:** April 6, 2026  
**Status:** Team circulation draft  
**Purpose:** Reframe the First Seed walkthrough so it cleanly follows the settled IDE object model.
...
**Expected dominant block types:** mostly `𒐛`, with strong `œ` lineage  
**Trust:** `L2`  
**Depth:** `3`  
**Evidence basis:** Direct text  
**Chronology:** Primary
...
6. **Did it touch reality?**
   - From external share and sealed receipt evidence
...
- aim completeness: green
- evidence quality: green
- convergence strength: green
- weld validity: green
- depth distribution: green
- seal integrity: green

That would justify `stage 7` settlement.

Important clarification:

- the hex remains computed output
- it is not manually declared by this walkthrough
- this document defines what evidence should make stage 7 defensible
